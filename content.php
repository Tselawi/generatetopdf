...
<div class="SVI-heading">
    ...
    <div class="sign">
        <p class="profile-text2">Signature____________<br><sub class="tgray">(signature)</sub></p>
    </div>
</div>
...
<div class="profile-details">
    ...
    <p class="profile-text">Volunteer ID <u>' . $member . '</u><br><sub class="tgray">(numero de membre)</sub></p>
