    ...
    <div class="container">
        ...
        <!-- ########################## profile page one ##########################-->
                    ...
                    <div class="profile-details">
                        ...
                        <p class="profile-text">Last Name: <?= $lname; ?><br><sub class="tgray">(nom)</sub></p>
                        <p class="profile-text">Membership Number: <?= $member; ?><br><sub class="tgray">(numero de membre)</sub></p>
                    </div>
                    <div class="sign">
                ...
                <div class="SVI-heading">
                    ...
                    <p class="profile-text2">Birth date: <?= $date; ?><br><sub class="tgray2">(date de naissance)</sub></p>
                    <p class="profile-text2">Nationality: <?= $nationality; ?><br><sub class="tgray2">(nationalite)</sub></p>
                    <p class="profile-text2">Current address:<br><sub class="tgray2">(addresse actuelle)</sub></p>
                    <p class="profile-text2">City:<br><sub class="tgray2">(ville)</sub></p>
                    <p class="profile-text2">Country:<br><sub class="tgray2">(pays)</sub></p>
                    <p class="profile-text2">Mobile phone<br><sub class="tgray2">(numero de portable)</sub></p>
                    <p class="profile-text2">Emergency number<br><sub class="tgray2">(numero d'urgence)</sub></p>
                </div>
                <div class="gender">
                    <p class="profile-text2">Sex<br><sub class="tgray2">(sexe)</sub></p>
                </div>
